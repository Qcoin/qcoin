...
"Copyright &copy; 2011-YYYY The Qcoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Qcoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Qcoin</b> version", 0));
