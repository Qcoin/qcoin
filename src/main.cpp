...
#if defined(NDEBUG)
# error "Qcoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xe3a848676dcfcb8156d769d96283edba5223aaeb26b8d793d391ca7e5b832473");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Qcoin: starting difficulty is 1 / 2^12
...
{
    // Qcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Qcoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Qcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Qcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Qcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=20, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=1c0a3b1639, nTime=1396268379, nBits=1e0ffff0, nNonce=750595, vtx=1)
        //   CTransaction(hash=1c0a3b1639, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        //     CTxIn(COutPoint(0000000000, -1), coinbase 04ffff001d01044c504e592054696d65732033302f30332f32303134204d616c6179736961204169726c696e657320466c6967687420333730206d697373696e672073696e63652037204d617263682031363a343120555443)
        //     CTxOut(nValue=50.00000000, scriptPubKey=047e17fc3533883d5fcc0c1e809033)
        //   vMerkleTree: 1c0a3b1639

        // Genesis block
        const char* pszTimestamp = "NY Times 30/03/2014 Malaysia Airlines Flight 370 missing since 7 March 16:41 UTC";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 4 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("047e17fc3533883d5fcc0c1e809033fd126ce3917caec73a9a19a0a147f24420325c1ba006c0f3f616b6007b49a7e7569c1b8b5d1c0639a10035beec9c4c9984f9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1396268379;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 750595;

        if (fTestNet)
        {
            block.nTime    = 1396268365;
            block.nNonce   = 21464;
        }
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Qcoin: increase each by adding 2 to bitcoin's value.
